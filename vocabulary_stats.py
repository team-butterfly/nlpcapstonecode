...
c_raw = Counter(word for sent in ds.train_raw_inputs for word in sent.split(" "))
...
for counts in (c_raw, c_tokenized):
    table.append( ("Num. unique tokens, split on spaces", len(counts)) )
